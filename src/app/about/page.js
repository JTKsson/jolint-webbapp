  ...
  return (
    <div>
      ...
      <p>
        ...
        we've stayed committed to these principles, ensuring that individuals'
        information is handled with care and respect. Discover the journey of
        Jolint, and join us in our quest to make the world a better place, one
        company at a time. With our innovative approach, cutting-edge
